...
echo "		</div>\n";
echo "		<div class='action_item' id='action_screen_share_audio' onclick='toggle_screen_share_audio();' style='display: none;'><i id='action_screen_share_audio_icon' class='fas fa-volume-up'></i>\n";
echo "			<span class='action_label' id='action_screen_share_audio_label'>Share Aud</span>\n";
echo "		</div>\n";
