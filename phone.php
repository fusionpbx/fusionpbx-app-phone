...
echo "				</select>\n";
echo "			</div>\n";
echo "			<div class='audio_output_selector_container'>\n";
echo "				<label for='audio_output_select' class='audio_device_label'><i class='fas fa-headphones'></i> Audio Output:</label>\n";
echo "				<select id='audio_output_select' class='audio_device_select'>\n";
echo "					<option value=''>Default Device</option>\n";
echo "				</select>\n";
echo "			</div>\n";
echo "			<div class='video_device_selector_container'>\n";
echo "				<label for='video_input_select' class='video_device_label'><i class='fas fa-video'></i> Video Input:</label>\n";
echo "				<select id='video_input_select' class='video_device_select'>\n";
echo "					<option value=''>Default Device</option>\n";
echo "				</select>\n";
echo "			</div>\n";
