...
echo "		</div>\n";
echo "		<div class='action_item' id='action_audio_source' onclick='toggle_screen_share_audio_source();' style='display: none;'><i id='action_audio_source_icon' class='fas fa-microphone'></i>\n";
echo "			<span class='action_label' id='action_audio_source_label'>Mic</span>\n";
echo "		</div>\n";
