...
$text['label-new_message']['ar-eg'] = "رسائل";
$text['label-new_message']['de-at'] = "Nachrichten";
$text['label-new_message']['de-ch'] = "Nachrichten";
$text['label-new_message']['de-de'] = "Nachrichten";
$text['label-new_message']['el-gr'] = "μηνύματα";
$text['label-new_message']['es-cl'] = "Mensajes";
$text['label-new_message']['es-mx'] = "Mensajes";
$text['label-new_message']['fr-ca'] = "Messages";
$text['label-new_message']['fr-fr'] = "Messages";
$text['label-new_message']['he-il'] = "הודעות";
$text['label-new_message']['it-it'] = "Messaggi";
$text['label-new_message']['nl-nl'] = "Berichten";
$text['label-new_message']['pl-pl'] = "Wiadomości";
$text['label-new_message']['pt-br'] = "Mensagens";
$text['label-new_message']['pt-pt'] = "Mensagens";
$text['label-new_message']['ro-ro'] = "Mesaje";
$text['label-new_message']['ru-ru'] = "Сообщения";
$text['label-new_message']['sv-se'] = "Meddelanden";
$text['label-new_message']['uk-ua'] = "Повідомлення";
$text['label-new_message']['tr-tr'] = "Mesajlar";
$text['label-new_message']['zh-cn'] = "消息";
$text['label-new_message']['ja-jp'] = "メッセージ";
$text['label-new_message']['ko-kr'] = "메시지";

$text['label-type_message']['en-us'] = "Type a message...";
$text['label-type_message']['ar-eg'] = "اكتب رسالة...";
$text['label-type_message']['de-at'] = "Nachricht eingeben...";
$text['label-type_message']['de-ch'] = "Nachricht eingeben...";
$text['label-type_message']['de-de'] = "Nachricht eingeben...";
$text['label-type_message']['el-gr'] = "Πληκτρολογήστε μήνυμα...";
$text['label-type_message']['es-cl'] = "Escribe un mensaje...";
$text['label-type_message']['es-mx'] = "Escribe un mensaje...";
$text['label-type_message']['fr-ca'] = "Tapez un message...";
$text['label-type_message']['fr-fr'] = "Tapez un message...";
$text['label-type_message']['he-il'] = "הקלידו הודעה...";
$text['label-type_message']['it-it'] = "Digita un messaggio...";
$text['label-type_message']['nl-nl'] = "Typ een bericht...";
$text['label-type_message']['pl-pl'] = "Wpisz wiadomość...";
$text['label-type_message']['pt-br'] = "Digite uma mensagem...";
$text['label-type_message']['pt-pt'] = "Escreva uma mensagem...";
$text['label-type_message']['ro-ro'] = "Scrie un mesaj...";
$text['label-type_message']['ru-ru'] = "Введите сообщение...";
$text['label-type_message']['sv-se'] = "Skriv ett meddelande...";
$text['label-type_message']['uk-ua'] = "Введіть повідомлення...";
$text['label-type_message']['tr-tr'] = "Bir mesaj yazın...";
$text['label-type_message']['zh-cn'] = "输入消息...";
$text['label-type_message']['ja-jp'] = "メッセージを入力...";
$text['label-type_message']['ko-kr'] = "메시지를 입력하세요...";

$text['label-send']['en-us'] = "Send";
$text['label-send']['ar-eg'] = "إرسال";
$text['label-send']['de-at'] = "Senden";
$text['label-send']['de-ch'] = "Senden";
$text['label-send']['de-de'] = "Senden";
$text['label-send']['el-gr'] = "Αποστολή";
$text['label-send']['es-cl'] = "Enviar";
$text['label-send']['es-mx'] = "Enviar";
$text['label-send']['fr-ca'] = "Envoyer";
$text['label-send']["fr-fr"] = "Envoyer";
$text['label-send']['he-il'] = "שלח";
$text['label-send']['it-it'] = "Invia";
$text['label-send']['nl-nl'] = "Verzenden";
$text['label-send']['pl-pl'] = "Wyślij";
$text['label-send']['pt-br'] = "Enviar";
$text['label-send']['pt-pt'] = "Enviar";
$text['label-send']['ro-ro'] = "Trimite";
$text['label-send']['ru-ru'] = "Отправить";
$text['label-send']['sv-se'] = "Skicka";
$text['label-send']['uk-ua'] = "Надіслати";
$text['label-send']['tr-tr'] = "Gönder";
$text['label-send']['zh-cn'] = "发送";
$text['label-send']['ja-jp'] = "送信";
$text['label-send']['ko-kr'] = "보내기";

$text['label-you']['en-us'] = "You";
$text['label-you']['ar-eg'] = "أنت";
$text['label-you']['de-at'] = "Du";
$text['label-you']['de-ch'] = "Du";
$text['label-you']['de-de'] = "Du";
$text['label-you']['el-gr'] = "Εσένα";
$text['label-you']['es-cl'] = "Tú";
$text['label-you']['es-mx'] = "Tú";
$text['label-you']['fr-ca'] = "Tu";
$text['label-you']['fr-fr'] = "Tu";
$text['label-you']['he-il'] = "את";
$text['label-you']['it-it'] = "Tu";
$text['label-you']['nl-nl'] = "Jij";
$text['label-you']['pl-pl'] = "Ty";
$text['label-you']['pt-br'] = "Você";
$text['label-you']['pt-pt'] = "Tu";
$text['label-you']['ro-ro'] = "Tu";
$text['label-you']['ru-ru'] = "Ты";
$text['label-you']['sv-se'] = "Du";
$text['label-you']['uk-ua'] = "Ти";
$text['label-you']['tr-tr'] = "Sen";
$text['label-you']['zh-cn'] = "你";
$text['label-you']['ja-jp'] = "あなた";
$text['label-you']['ko-kr'] = "당신";
